    ...
    <div>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route exact path="/question/:quizId" element={<QuestionHome />}/>
          ...
          <Route exact path="/addCategory" element={<AddOrUpdateCategory />}/>
          <Route exact path="/updateCategory/:categoryId" element={<AddOrUpdateCategory />}/>
          ...
          <Route exact path="/quiz/:categoryId" element={<QuizHome />}/>
          ...
          <Route exact path="/add-quiz" element={<AddOrUpdateQuiz />}/>
          <Route exact path="/add-quiz/:categoryId" element={<AddOrUpdateQuiz />}/>
          <Route exact path="/update-quiz/:quizId" element={<AddOrUpdateQuiz />}/>
          ...
          <Route exact path="/question" element={<QuestionHome />}/>
          <Route exact path="/question/:quizId" element={<QuestionHome />}/>
          <Route exact path="/add-question" element={<AddOrUpdateQuestion />}/>
          <Route exact path="/add-question/:quizId" element={<AddOrUpdateQuestion />}/>
          <Route exact path="/update-question/:questionId" element={<AddOrUpdateQuestion />}/>




          <Route exact path="/userQuestion/:quizId" element={<UserTest />}/>
          ...
          <Route exact path="/report" element={<TestReport />}/>
