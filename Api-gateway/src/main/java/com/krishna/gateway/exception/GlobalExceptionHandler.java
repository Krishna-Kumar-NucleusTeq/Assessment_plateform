package com.krishna.gateway.exception;
...
import com.krishna.gateway.util.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ErrorResponse> handleUnauthorizedAccessException(
